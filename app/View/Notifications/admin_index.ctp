<div class="notifications index">
	...
	<tr>
		...
		<td><?php echo h($notification['Notification']['head']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($notification['Users']['name'], array('controller' => 'users', 'action' => 'view', $notification['Users']['id'])); ?>
		</td>
		<td class="actions">
